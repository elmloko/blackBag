...
-- Volcando datos para la tabla blackbag.pulse_aggregates: ~123 rows (aproximadamente)
INSERT INTO `pulse_aggregates` (`id`, `bucket`, `period`, `type`, `key`, `aggregate`, `value`, `count`) VALUES
	...
	(359, 1730746080, 10080, 'user_request', '1', 'count', 10.00, NULL),
	...
	(414, 1730748960, 1440, 'user_request', '1', 'count', 1.00, NULL);
...
-- Volcando datos para la tabla blackbag.pulse_entries: ~94 rows (aproximadamente)
